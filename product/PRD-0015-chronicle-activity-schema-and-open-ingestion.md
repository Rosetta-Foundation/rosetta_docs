...
- **Siri / OS voice log producer:** [PRD-0018](PRD-0018-siri-chronicle-voice-log.md) posts spoken personal journal text through a personal capture bridge; Phase 2 of that PRD emits `ext:rosetta/siri-log` envelopes into this inbox.
- **Physical-world capture producers:** robots and fixed capture rigs (camera + page-turner + OCR digitizing a physical book, a shelf scanner, a whiteboard camera) are just `ext:` producers emitting schema-valid envelopes — the hardware is never ours, the schema is the entire contract. Copyrighted captures (e.g. an accessible-format copy of a book for a print-disabled owner, lawful under the Marrakesh Treaty / 17 U.S.C. §121–121A) stay in the personal chronicle by construction: the promotion gate (PRD-0006/0009) is the compliance boundary and denies them. Consumption surface: PRD-0017.
